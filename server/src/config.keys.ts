...
export const GOOGLE_KEY = {
  clientID: process.env.GOOGLE_KEY_CLIENTID || "625344785498-m5ab7q9aonisv78e9fv973usfgnq0onq.apps.googleusercontent.com",
  clientSecret: process.env.GOOGLE_KEY_CLIENTSECRET || "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",
};
